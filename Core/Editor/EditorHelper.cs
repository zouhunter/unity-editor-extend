...
namespace EditorTools
{
    ...
    /// <summary>
    /// group of function for the editor programing
    /// </summary>
    ...
    public class EditorHelper
    {
        ...
        static public void DrawToolbars(ref bool plus, ref bool minus, bool canRemove)
        {
            ...
            plus = GUI.Button(rect1, EditorHelper.iconToolbarPlus, EditorHelper.preButtonStyle);
            EditorGUI.BeginDisabledGroup(!canRemove);
            minus = GUI.Button(rect2, EditorHelper.iconToolbarMinus, EditorHelper.preButtonStyle);
